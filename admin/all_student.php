...
include("header.php");
  ...
  $rowsperpage = 200;
   ...
   if($_REQUEST['status']=="all" || $_REQUEST['status']==""){
     $sql2 = "SELECT * FROM tbl_registration ORDER BY id DESC LIMIT " . $pagination->getLimit() . ", " . $rowsperpage; 
    
   }
    elseif($_REQUEST['status']!="all" && $_REQUEST['status']!=""){
    $sql2 = "SELECT * FROM tbl_registration WHERE status = '".$_REQUEST['status']."' ORDER BY id DESC LIMIT " . $pagination->getLimit() . ", " . $rowsperpage; 
...
<div class="content-wrapper">
  ...
  <section class="content-header">
   ...
   <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="#"><i class="fa fa-files-o"></i>Our Team Management</a></li>
    ...
    <tbody>
     ...
     <tr>
      ...
      <td><?php echo $row['company'] ?></td>
       <td>
        <ul class="actions"> 
          <li><a href="veiwuser.php?id=<?php echo $row['id'];?>" title="Edit"><i class="fa fa-eye" aria-hidden="true"></i></a></li>
          <li><a href="action/all_student.php?subview=delete&id=<?php echo $row['id'];?>" onclick="return confirm('Are you sure?')"><i class="fa fa-trash"></i></a></li>
        </ul>
      </td> 
   </tr>
