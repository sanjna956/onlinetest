			...
			<img src="<?php echo URL; ?>images/logo.png" alt="logo" />   
                <div id="loginform">
                    <div class="text-center p-t-20 p-b-20">
                        <span class="db">Trinity Global Tech Inc (TGT)</span> 
                    </div>
                    <!-- Form -->
                        ...
                        <div class="row p-b-30">
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control form-control-lg" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" required="" name="user_name">
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
